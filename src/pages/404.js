...
export default () => (
	<>
		<Heading title={'404 Not found'} subtitle={'Uh-oh! Looks like the page you were looking for doesn\'t exist.'}/>
		...
		<Container type='body'>
			...
			<div className='fourOhFourGrid'>
				<div>
					<h4>Hockey</h4>
					<ul>
						<li><Link to='/programs/hockey'>Pre-season skills and skating</Link></li>
						<li><Link to='/programs/hockey'>Ice rental</Link></li>
					</ul>
				</div>
				...
				<div>
					<h4>Horses</h4>
					<ul>
						<li><Link to='/programs/horses'>Trail rides</Link></li>
						<li><Link to='/programs/horses'>Riding lessons</Link></li>
						<li><Link to='/programs/horses'>Hunter/Jumper shows</Link></li>
						<li><Link to='/programs/horses'>Schooling ring rental</Link></li>
					</ul>
				</div>
			</div>	
